(() => {
    ...
    function initSliders() {
        if (document.querySelector(".license__slider")) new core(".license__slider", {
            ...
            navigation: {
                prevEl: ".license__button-arrow_prev",
                nextEl: ".license__button-arrow_next"
            },
            autoHeight: true,
            breakpoints: {
                320: {
    ...
    ymaps.ready((function() {
        var myMap = new ymaps.Map("map", {
            center: [ 47.24669706614902, 39.771803717669364 ],
            zoom: 15.12
        }, {
            searchControlProvider: "yandex#search"
        }), myPlacemark = new ymaps.Placemark(myMap.getCenter(), {
            hintContent: "ПРОСПЕКТ МИРА",
            balloonContent: "ПРОСПЕКТ МИРА"
        }, {
